...
export const studyContent: DomainStudyContent[] = [
  ...
  // ─────────────────────────────────────────
  {
    ...
    keyTerms: [
      { term: "COBIT 2019", definition: "ISACA's IT governance framework providing a set of governance and management objectives." },
      { term: "Three Lines of Defense", definition: "Governance model: 1st = business units (own risk), 2nd = security/compliance (oversee), 3rd = internal audit (assure)." },
      { term: "CISO", definition: "Chief Information Security Officer — executive accountable for the information security program." },
      { term: "Maturity Model", definition: "Framework (e.g., CMMI) for assessing program capability on a scale and guiding improvement." },
      { term: "KPI", definition: "Key Performance Indicator — metric measuring effectiveness of security program activities." },
      { term: "KRI", definition: "Key Risk Indicator — early-warning metric signaling that a risk is increasing or a threshold may be breached." },
      { term: "Security Steering Committee", definition: "Cross-functional body providing governance oversight and aligning security with business priorities." },
      { term: "Gap Analysis", definition: "Comparison of current security state against a target state to identify improvement priorities." },
      { term: "ROSI", definition: "Return on Security Investment — ratio of expected risk reduction to cost of a security control." },
      { term: "Policy Exception", definition: "Formal, documented approval to deviate from a policy with compensating controls and a review date." },
    ],
    examTips: [
  ...
  },
  {
    ...
    keyTerms: [
      { term: "Inherent Risk", definition: "The level of risk present before any controls are applied." },
      { term: "Residual Risk", definition: "Risk remaining after controls have been implemented; must be within risk tolerance." },
      { term: "Risk Appetite", definition: "The total amount of risk the Board is willing to accept in pursuit of business objectives." },
      { term: "Risk Tolerance", definition: "The acceptable operational variation around the risk appetite; the day-to-day working boundary." },
      { term: "Risk Register", definition: "Central repository tracking all identified risks with their ratings, owners, treatment, and review status." },
      { term: "FAIR", definition: "Factor Analysis of Information Risk — quantitative model for measuring and communicating information risk." },
      { term: "ALE", definition: "Annual Loss Expectancy = Single Loss Expectancy × Annual Rate of Occurrence; core quantitative risk metric." },
      { term: "Risk Heat Map", definition: "Visual 5×5 matrix plotting risks by likelihood and impact to prioritize treatment." },
      { term: "Risk Scenario", definition: "Narrative description of how a specific threat could materialize and harm the organization." },
      { term: "Risk Owner", definition: "Business manager accountable for a risk and its treatment — not the CISO." },
      { term: "KRI", definition: "Key Risk Indicator — metric providing early warning of increasing risk toward a defined threshold." },
    ],
    examTips: [
  ...
  },
  {
    ...
    keyTerms: [
      { term: "Defense in Depth", definition: "Layered security controls such that no single failure results in a full compromise." },
      { term: "Zero Trust", definition: "Architecture requiring continuous verification of every user and device; no implicit trust from network location." },
      { term: "Program Charter", definition: "Document formally defining the security program's scope, authority, accountability, and funding." },
      { term: "Preventive Control", definition: "Control designed to stop an incident from occurring (e.g., firewall, access controls, encryption)." },
      { term: "Detective Control", definition: "Control designed to identify an incident after it occurs (e.g., SIEM, IDS, audit logs)." },
      { term: "Corrective Control", definition: "Control designed to restore normal operations after an incident (e.g., backup restoration, patch)." },
      { term: "Control Effectiveness", definition: "Degree to which a security control reduces risk as designed; measured through testing and metrics." },
      { term: "Fourth-Party Risk", definition: "Risk introduced by a vendor's own suppliers or subcontractors." },
      { term: "SOC 2", definition: "Third-party audit report assessing a service organization's security, availability, and privacy controls." },
      { term: "Security Culture", definition: "The degree to which employees make security-conscious decisions naturally as part of their normal work." },
      { term: "Compensating Control", definition: "Alternative control providing equivalent protection when the primary control cannot be implemented." },
    ],
    examTips: [
  ...
  },
  {
    ...
    keyTerms: [
      ...
      { term: "Playbook", definition: "Pre-defined, step-by-step procedure for responding to a specific type of incident." },
      { term: "MTTD", definition: "Mean Time to Detect — average time from incident occurrence to its detection." },
      { term: "MTTR", definition: "Mean Time to Respond/Remediate — average time from detection to full resolution." },
      { term: "Chain of Custody", definition: "Documented record of who handled evidence, when, and how — required for legal admissibility." },
      { term: "Lessons Learned", definition: "Post-incident review documenting what happened, what worked, what failed, and how to improve." },
      { term: "RTO", definition: "Recovery Time Objective — maximum acceptable duration of downtime before business impact becomes unacceptable." },
      { term: "RPO", definition: "Recovery Point Objective — maximum acceptable amount of data loss measured in time." },
      { term: "Tabletop Exercise", definition: "Discussion-based IR test where participants verbally walk through a scenario without activating real systems." },
      { term: "Legal Hold", definition: "Preservation obligation requiring all potentially relevant data to be retained once litigation is anticipated." },
      { term: "Containment", definition: "IR phase where affected systems are isolated to stop further spread, occurring before eradication." },
      { term: "Eradication", definition: "IR phase where the threat is removed — malware deleted, entry vector closed, credentials reset." },
    ],
    examTips: [
